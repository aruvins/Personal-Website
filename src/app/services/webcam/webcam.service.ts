...
export class WebcamService {
  ...
  public async loadModels(): Promise<void> {
    // Load FaceNet model
    this.faceNetModel = await tf.loadGraphModel('../../../assets/facenet_keras.h5');
    console.log('FaceNet model loaded');

    // Load Age and Gender classifier
    this.ageGenderModel = await tf.loadLayersModel('path_to_your_age_gender_model/model.json');
